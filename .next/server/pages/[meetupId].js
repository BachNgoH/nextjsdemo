...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://testuser:Nlmbao2004@cluster0.cyeut.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
